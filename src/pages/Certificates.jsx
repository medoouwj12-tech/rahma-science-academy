...
const certificates = [
  {
    id: 1,
    title: 'إتمام دورة الكيمياء — الفصل الأول',
    course: 'الكيمياء — الصف الثالث',
    issuedAt: '15 مايو 2026',
    grade: 'A+',
    score: 96,
    certNo: 'RK-CHM-2026-04821',
    color: 'from-amber-400 via-yellow-500 to-amber-700',
    emoji: '⚗️',
  },
  {
    id: 2,
    title: 'إتمام دورة الفيزياء — الميكانيكا',
    course: 'الفيزياء — الصف الثاني',
    issuedAt: '02 أبريل 2026',
    grade: 'A',
    score: 91,
    certNo: 'RK-PHY-2026-03104',
    color: 'from-cyan-400 via-sky-500 to-blue-700',
    emoji: '🧪',
  },
  {
    id: 3,
    title: 'إتمام دورة اللغة العربية — النحو',
    course: 'اللغة العربية — الثانوية',
    issuedAt: '18 مارس 2026',
    grade: 'A+',
    score: 94,
    certNo: 'RK-ARB-2026-02156',
    color: 'from-violet-400 via-purple-500 to-violet-700',
    emoji: '📖',
  },
  {
    id: 4,
    title: 'امتحان تفاعلي — بنك الأسئلة',
    course: 'اختبار التميز — الكيمياء',
