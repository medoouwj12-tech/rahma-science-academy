        ...
        {mobileOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 h-full w-[280px] border-l border-white/10 bg-black p-4 flex flex-col justify-between"
            >
              <div>
                ...
                <nav className="space-y-1 overflow-y-auto max-h-[80vh]">
                  {sidebarNav.map((item) => {
                    const Icon = INSTRUCTOR_ICONS[item.icon] || LayoutDashboard;
                    ...
                    return (
                      <button
                        ...
                        className={`flex w-full items-center gap-3 rounded-xl px-3 py-3 text-right text-sm font-semibold transition-all ${
                          isActive
                            ? 'bg-gradient-to-l from-gold-400/15 to-transparent text-gold-100'
