  ...
  return (
    ...
    >
      <a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 shadow-[0_0_15px_rgba(16,185,129,0.4)] transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.5)]"
      ...
      >
        ...
        <svg
          viewBox="0 0 24 24"
          className="h-7 w-7 fill-[#ffffff] drop-shadow-[0_2px_5px_rgba(0,0,0,0.2)] transition-transform group-hover:scale-110"
        ...
        {/* Tooltip */}
        <span className="pointer-events-none absolute right-16 top-1/2 -translate-y-1/2 scale-75 whitespace-nowrap rounded-xl border border-emerald-500/20 bg-[#0f172a]/95 px-3.5 py-1.5 text-xs font-bold text-[#ffffff] opacity-0 shadow-gold-glow backdrop-blur-md transition-all group-hover:scale-100 group-hover:opacity-100">
